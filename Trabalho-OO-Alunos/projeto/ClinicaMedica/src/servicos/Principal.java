            ...
            if (escolha == 1) {
                ...
                if (subEscolha == 1) {
                    ...
                    for (int i = 0; i < agendamentos.size(); i++) {
                        ...
                        System.out.println((i + 1) + ". Data: " + agendamento.getData() + ", Horário: " + agendamento.getHorario() + ", Paciente: " + agendamento.getPaciente().getNome() + ", Médico: " + agendamento.getMedicoResponsavel().getNome());
                    }
                    ...
                    agendamento.setDuracao(novaDuracao);
                ...
                if (subEscolha == 1) {
                    ...
                    agendamento.getMedicoResponsavel().getHistorico().getConsultas()[consultas.size() - 1] = consulta;
                    ...
                    for (int i = 0; i < consultas.size(); i++) {
                        ...
                        System.out.println((i + 1) + ". Data: " + consulta.getAgendamento().getData() + ", Horário: " + consulta.getAgendamento().getHorario() + ", Paciente: " + consulta.getAgendamento().getPaciente().getNome() + ", Médico: " + consulta.getAgendamento().getMedicoResponsavel().getNome() + ", Status: " + consulta.getStatus());
                    }
                    ...
                    for (int i = 0; i < consulta.getAgendamento().getMedicoResponsavel().getHistorico().getConsultas().length; i++) {
                        if (consulta.getAgendamento().getMedicoResponsavel().getHistorico().getConsultas()[i] == consulta) {
                            consulta.getAgendamento().getMedicoResponsavel().getHistorico().getConsultas()[i] = null;
                            break;
                        }
                    }
                ...
                if (subEscolha == 1) {
                    ...
                    consulta.setPrescricaoAssociada(prescrição);
                    consulta.getAgendamento().getPaciente().getHistorico().setExames(new Exame[] {exame});
                    consulta.getAgendamento().getMedicoResponsavel().getHistorico().setExames(new Exame[] {exame});
                    ...
                    consulta.setPrescricaoAssociada(null);
                ...
                if (subEscolha == 1) {
                    ...
                    for (int i = 0; i < exames.size(); i++) {
                        ...
                        System.out.println((i + 1) + ". Tipo: " + exame.getTipo() + ", Data da Prescrição: " + exame.getDataPrescricao() + ", Data de Realização: " + exame.getDataRealizacao() + ", Data de Validade: " + exame.getDataValidade() + ", Custo: " + exame.getCusto());
                    }
                    ...
                    exame.setDataPrescricao(novaDataPrescrição);
                    exame.setDataRealizacao(novaDataRealizacao);
