...
public class Medico extends Usuario {
    ...
    public void lerCadastro() {
        ...
        for (Consulta consulta : historico.getConsultas()) {
            if (consulta != null) {
                System.out.println("  Data: " + consulta.getAgendamento().getData() + ", Horário: " + consulta.getAgendamento().getHorario() + ", Duração: " + consulta.getAgendamento().getDuracao() + " min, Paciente: " + consulta.getAgendamento().getPaciente().getNome() + ", Valor: " + consulta.getValor() + ", Status: " + consulta.getStatus());
            }
        }
    }
